...
```{r}
LS_read_ratings <- read_excel("Likert Scale/all_completed_ranked_new.xlsx", sheet = "read_rank_above")
LS_coh_ratings <- read_excel("Likert Scale/all_completed_ranked_new.xlsx", sheet = "cohe_rank_above")
```
...
```{r}
RME_read_ratings <- read_excel("RME/all_completed_modified.xlsx", sheet = "read_rank_above")
RME_coh_ratings <- read_excel("RME/all_completed_modified.xlsx", sheet = "cohe_rank_above")
...
```{r}
BME_read_ratings <- read_excel("BME/all_completed_modified.xlsx", sheet = "read_rank_above")
BME_coh_ratings <- read_excel("BME/all_completed_modified.xlsx", sheet = "cohe_rank_above")
...
```{r}
RR_read_ratings <- read_excel("RR/all_completed_modified.xlsx", sheet = "read_rank_above")
RR_coh_ratings <- read_excel("RR/all_completed_modified.xlsx", sheet = "cohe_rank_above")
