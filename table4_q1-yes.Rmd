...
```{r}
LS_read_ratings <- read_excel("Likert Scale/all_completed_ranked_new.xlsx", sheet = "read_q1yes")
LS_coh_ratings <- read_excel("Likert Scale/all_completed_ranked_new.xlsx", sheet = "cohe_q1yes")
```
...
```{r}
RME_read_ratings <- read_excel("RME/all_completed_modified.xlsx", sheet = "read_q1yes")
RME_coh_ratings <- read_excel("RME/all_completed_modified.xlsx", sheet = "cohe_q1yes")
...
```{r}
BME_read_ratings <- read_excel("BME/all_completed_modified.xlsx", sheet = "read_q1yes")
BME_coh_ratings <- read_excel("BME/all_completed_modified.xlsx", sheet = "cohe_q1yes")
...
```{r}
RR_read_ratings <- read_excel("RR/all_completed_modified.xlsx", sheet = "read_q1yes")
RR_coh_ratings <- read_excel("RR/all_completed_modified.xlsx", sheet = "cohe_q1yes")
